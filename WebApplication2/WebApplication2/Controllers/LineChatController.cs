...
namespace WebApplication2.Controllers
{
    public class LineChatController : ApiController
    {
        ...
        public IHttpActionResult POST()
        {
            ...
            var Cp = new isRock.LineBot.CarouselTemplate()
            {
                altText = "123",
                columns = new List<isRock.LineBot.Column>() 
                {
                    new isRock.LineBot.Column()
                    {
            ...
            try
            {
                ...
                isRock.LineBot.Utility.PushTemplateMessage(ReceivedMessage.events[0].source.userId, Cp, ChannelAccessToken);
                //回覆API OK
                return Ok();
            }
            catch (Exception ex)
